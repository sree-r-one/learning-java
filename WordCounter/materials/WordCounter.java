...
public class WordCounter {
	...
	/**
	 * Gets a list of words that appear a particular number of times, indicated by
	 * the given threshold.
	 * 
	 * Hint(s):
	 * - For each word (key) in the wordCount map, check if the associated word
	 * count (value) is >= threshold.
	 * 
	 * Example(s):
	 * - If the list of lines contains:
	 * "war and the"
	 ...
	 * "the war the"
	 * 
	 * Calling getWordsOccuringMoreThan(3) would return an ArrayList<String> with:
	 * "war", "the"
	 ...
	 * "thE war The"
	 * 
	 * Calling getWordsOccuringMoreThan(2) would return an ArrayList<String> with:
	 * "war", "the"
	 ...
	 * 
	 * @param threshold (minimum word count) for words to include in the returned
	 *                  list,
