...
public class Vehicle {
	 ...
	 * Therefore, when bike calls refuel, nothing should happen. Just print: "You
	 * don't need to refuel a bike."
	 * 
	 * For the car, you have to make sure there's room in the gas tank for the given
	 * amount of gas.
	 * If the given amount of gas plus the remaining amount of gas in the tank is
	 * greater than the
	 * max amount of gas the tank can hold, set the remaining amount of gas to be
	 * the max amount of gas
	 * the tank can hold. Otherwise, add the given amount of gas to the gas
	 ...
	 * Therefore, when bike calls run, nothing should happen. Just print
	 ...
	 * Otherwise, you need to calculate the gas consumed during this run. Take the
	 * given number of hours that
	 * the car is going to run and multiply by the gas consumed per hour. Then
	 * subtract from the gas remaining in the tank.
	 * If the gas remaining in the tank is smaller than or equal to 0 for this run,
	 * print "Oops, gas out! Please add fuel!"
	 * and set the gas remaining to be 0.
	 * Make sure to add the gas consumed during this run to the total gas consumed
	 * by the car. If the gas consumed during
	 * this run is greater than the gas remaining in the tank, add the remaining gas
	 ...
	 * - Then if you call refuel(100), followed by run(5), the gasRemained would be
	 * 50
