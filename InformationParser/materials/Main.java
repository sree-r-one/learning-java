 ...
 * The program will read and parse text from a file, process and extract the
 * information needed,
 * request new information from the user, and then write all of the information
 * to a new file.
 * 
 * The Main class will drive the entire program, and the “main” method calls
...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * Create new instance of file writer which writes to the file
		 * "personal_info.txt"
		 */
		...
		/*
		 * Add the Strings which will be written to the file to the ArrayList
		 * linesToWrite
		 */
		...
		System.out.print(
				"Thank you for waiting! The course information and your personal information has been exported to a file. ");
	}
}